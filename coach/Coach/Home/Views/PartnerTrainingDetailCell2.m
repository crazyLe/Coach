...
@property(nonatomic,strong)NSMutableArray * selectedTimeModelArray;
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        self.selectedTimeModelArray = [NSMutableArray array];
...
-(void)layoutSubviews
{
    ...
    for (int i = 0; i<self.dayBtnArray.count; i++) {
        ...
        if (i == 2) {
            ...
            btn.bgImageView.image = [UIImage imageNamed:@"iconfont-earnextralmoneybg"];
    ...
    CGFloat itemViewHeight =  itemViewWidth*0.65;
    ...
    NSInteger totalRow = (self.orderViewArray.count-1)/3+1;
...
-(void)orderItemClick:(OrderItemView *)itemView
{
    ...
    if (itemView.selected) {
        [self.selectedTimeModelArray addObject:@"1"];
    }
