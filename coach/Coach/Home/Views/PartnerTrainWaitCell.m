...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        middleImageView.image = [UIImage imageNamed:@"iconfont-smallcar"];
        ...
        [bigButton setTitleColor:[UIColor colorWithHexString:@"999999"] forState:UIControlStateNormal];
...
-(void)layoutSubviews
{
    ...
    middleImageView.frame = CGRectMake(4, 13,35, 24);
