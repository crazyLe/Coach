...
- (void)initSubviews
{
    ...
    dateLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0,(kScreenWidth-40)/3.0, 25)];
//    dateLabel.text = @"07:00-08:00";
    ...
    subjectsLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(dateLabel.frame)+8, (kScreenWidth-40)/3.0, 10)];
...
//    subjectsLabel.text = @"科二";
    ...
    personNumLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(subjectsLabel.frame)+2, (kScreenWidth-40)/3.0, 10)];
