...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        [bigButton setBackgroundImage:[UIImage imageNamed:@"iconfont-whitebackgound"] forState:UIControlStateNormal];
        [self.contentView addSubview:bigButton];
        
        UIImageView *iconImageView = [[UIImageView alloc]init];
        _iconImageView = iconImageView;
        iconImageView.image = [UIImage imageNamed:@"iconfont-multiply"];
        [self.contentView addSubview:iconImageView];
        
        UILabel *titleLabel = [[UILabel alloc]init];
        _titleLabel = titleLabel;
        _titleLabel.font = [UIFont boldSystemFontOfSize:15*AutoSizeScaleX];
        titleLabel.textColor = [UIColor colorWithHexString:@"fe812e"];
        ...
        subTiltleLabel.textColor = [UIColor colorWithHexString:@"999999"];
        ...
        zhuanDouLabel.textColor = [UIColor colorWithHexString:@"999999"];
...
-(void)layoutSubviews
{
    ...
    bigImageView.frame = CGRectMake(14, 22, 15, 15);
