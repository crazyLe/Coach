...
- (void)viewDidLoad {
    ...
    NSArray *navBtns = [self createNavWithLeftBtnImageName:@"iconfont-loginback" leftHighlightImageName:nil leftBtnSelector:@selector(back) andCenterTitle:nil andRightBtnImageName:nil rightHighlightImageName:nil rightBtnSelector:@selector(rightClick) withRightBtnTitle:@"发布"];
...
//    self.textView.clearButtonType = ClearButtonAppearWhenEditing;
    self.textView.frame = CGRectMake(0, 64, kScreenWidth, 310-64);
    ...
    sendToolBar.frame = CGRectMake(0, 64+310-64, kScreenWidth, 40);
...
-(void)reloadImageSubviewLayout
{
    ...
    if (self.imageArray.count > 0) {
        ...
        for (int i = 0; i<self.imageArray.count; i++) {
            ...
            imageView.frame = CGRectMake(margin+(margin+imageW)*i, 64+310-imageW-64-40, imageW, imageW);
...
-(NSArray *)createNavWithLeftBtnImageName:(NSString *)leftName leftHighlightImageName:(NSString *)leftHightlightName leftBtnSelector:(SEL)leftSelector andCenterTitle:(NSString *)title andRightBtnImageName:(NSString *)rightName rightHighlightImageName:(NSString *)rightHighlightName rightBtnSelector:(SEL)rightSelector withRightBtnTitle:(NSString *)rightTitle
{
    ...
    leftBtn.frame = CGRectMake(0,0,70,35);
    [leftBtn setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
    [leftBtn setContentEdgeInsets:UIEdgeInsetsMake(0, -5, 0, 5)];
    if (leftName) {
