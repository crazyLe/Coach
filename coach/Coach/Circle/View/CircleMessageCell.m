...
-(void)setMessageModel:(CircleMessageModel *)messageModel
{
    ...
    [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:messageModel.imgUrl] placeholderImage:[UIImage imageNamed:@"iconfont-defaultheadimage"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        if (error) {
...
//    NSLog(@"content===>%@",messageModel.content);
