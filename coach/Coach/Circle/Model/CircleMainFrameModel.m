...
//    self.topBestImageViewF = CGRectMake(kScreenWidth-20, 0, 15, 15);
    self.topBestImageViewF = CGRectMake(kScreenWidth-40, 0, 30, 35);
...
{
    CGFloat commentBtnW = 60*kScreenWidth / 375;
